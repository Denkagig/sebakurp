					...
					<div id="navbar" class="navbar container">
						...
						<nav class="navbar__nav nav nav--navbar">
							<ul class="nav__list">
								...
								<li class="nav__list-item"><a href="https://forum.arz-maryland.ru" class="nav__link">Форум</a></li>
								<li class="nav__list-item"><a href="/shop" class="nav__link">Магазин</a></li>
							</ul>
						</nav>
								<div class="navbar__profile"><a href="/shop" class="btn btn--red btn--navbar">Пополнить счет</a> </div>
