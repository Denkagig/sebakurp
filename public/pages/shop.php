...
<div class="layout__content">
	<div class="shop-page">
		<div class="container">
			<h1 class="shop-title">Донат <?php echo $config['nameproject'];?></h1>
			<div class="form">
				<form action='../pay/payok_start.php' method= 'POST'>
					<div class="input-group">
						<div class="input input--blue">
							...
							<div class="input__row">
								...
								<input id="username" name="nickname" placeholder="Игровой ник" maxlength="25" class="input__element">
							</div>
    ...
    <input id="sum" name="summa" placeholder="Сумма" type="number" class="input__element">
</div>
    ...
    document.getElementById('sum').addEventListener('input', function () {
            ...
            this.value = 50000;
					...
					<div class="calculator">
						...
						<div class="calculator__output">
							...
							<div class="calculator__value counter_get">0<span> AZ Rub</span></div>
						</div>
					</div>
		...
		<script>
			$('#sum').keyup(function () {
				...
				$('.counter_get').html(sum*<?php echo $config['donat_x']?>+'<span> AZ Rub</span>');
			});
			</script>
